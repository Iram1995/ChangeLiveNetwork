	...
	<section class="wrapper">
	   ...
	   //              }
		...
		// }
            ...
            <?php
            //     $findOverDate0 = mysqli_query($con, "SELECT * FROM mlmmembers WHERE targetdate<'$currentDate'");
            //     while ($rowDate0 = mysqli_fetch_assoc($findOverDate0)) {
            //             $DateUsername=$rowDate0['username'];
            ...
            <?php if($directDownliners<"3"){?>
	            ...
	            <?php
	             //$autoBlockSQL20 = mysqli_query($con,"UPDATE mlmmembers SET status='1',statusreason='Downliners',statusdate='$currentDate'");
