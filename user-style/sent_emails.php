...
<!DOCTYPE html>
<head>
<title>Change Lives Network : Sent messages</title>
                ...
                <section class="panel">
                    <div class="panel-body">
                        ...
                        <ul class="nav nav-pills nav-stacked mail-nav">
                            ...
                            <li class="active"><a href="#"> <i class="fa fa-envelope-o"></i> Sent <span class="label label-danger pull-right inbox-notification"><?=$userSentMsgs;?></span></a></li>
                        </ul>
                    </div>
                </section>
            </div>
            <div class="col-sm-9 mail-w3agile">
                <section class="panel">
                    <header class="panel-heading wht-bg">
                       <h4 class="gen-case">Sent (<?=$userSentMsgs;?>)
                    ...
                    <div class="panel-body minimal">
                        ...
                        <tbody>
                          <?php
                            $sqlUserMSG = mysqli_query($con,"SELECT * FROM mlmtickets WHERE sender='user' order by datesent DESC");
