...
<!DOCTYPE html>
<head>
<title>Change Lives Network | Deposit to Activate</title>
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="Profile">
              ...
              available to withdraw.
                ...
                <p>Note: Activation is $40 But it will be converted into bitcoin amount.</p>
                <br>
                  <form class="form" action="" method="post" >
                      <div class="form-group row">
                          <div class="col-xs-10">
                              <label><h4>Enter Amount</h4></label>
                              <input type="text" class="form-control" name="amount" title="Enter amount to withdraw" value="40.00" readonly>
                          </div>
                      </div>
                      ...
                      <div class="form-group row">
                           <div class="col-xs-10">
                                <br>
                                <button class="btn btn-lg btn-success" name="deposit" type="submit">Deposit</button>
