...
<!DOCTYPE html>
<head>
<title>Change Lives Network : My Phase 2 Genealogy</title>
        ...
        <ul>
            <li>
                ...
                <ul class="active">
                    <?php
                        $text_phase2 = "Phase 2";
                        $geneasql="SELECT * FROM mlmmembers WHERE parentid='$userid' AND currentstage='$text_phase2' order by userid ASC";
                    ...
                    <li>
                        ...
                        <ul class="active">
                          <?php
                          $text_phase2 = "Phase 2";
                            $geneasql1="SELECT * FROM mlmmembers WHERE parentid='$dlUserid' AND currentstage='$text_phase2' order by userid ASC";
                          ...
                          ?>
                            <li>
                              ...
                              <ul>
                                <?php
                                $text_phase2 = "Phase 2";
                                  $geneasql2="SELECT * FROM mlmmembers WHERE parentid='$granUserid' AND currentstage='$text_phase2' order by userid ASC";
                                ...
                                ?>
                                    ...
                                    <li>
                                        ...
                                        <ul>
                                          <?php
                                          $text_phase2 = "Phase 2";
                                            $geneasql3="SELECT * FROM mlmmembers WHERE parentid='$greatUserid' AND currentstage='$text_phase2' order by userid ASC";
