...
<div class="registrationform">
      ...
      <form name="registeradmin" id="registeradmin" method="post" action="/admin/?section=editadmininfo">           
            ...
            <div class="control-group">
                  <div class="control" style="border: 0px solid #333;">
                        ...
                        <input type="text" name="adminusername" id="adminusername" placeholder="Choose Username" value="<?php echo $adminusername;?>" disabled>
                  </div> 
                  <div class="control">
