...
<!DOCTYPE html>
<head>
<title>Change Lives Network : Edit Announcement</title>
...
<section id="main-content" style="background: #ffffff;">
  <section class="wrapper">
    ...
    <div class="row">
        <div class="col-sm-9">
            <?php if($editErrMSG){ echo $editErrMSG;}?>
                  ...
                  <form class="form" action="" method="post">
                      <div class="form-group row">
                          ...
                          <div class="col-xs-10">
                              ...
                              <input type="text" class="form-control" name="title" placeholder="Enter Title" title="Enter  Title" value="<?=$annTitle;?>" >
                          </div>
                      </div>
                      <div class="form-group row">
                          
                          <div class="col-xs-10">
                            <label><h4>Announcement</h4></label>
                              <textarea type="text" rows="8" name="announcement" class="form-control">
                                <?php echo $annMessage;?>
                              </textarea>
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                           <div class="col-xs-12">
                                <br>
                                <button class="btn btn-lg btn-success" name="editannouncement" type="submit">Save Changes</button>
