...
<?php   
    ...
    $annUser="";
    $annUser=isset($_GET['to'])?$_GET['to']:'na';
...
<section id="main-content" style="background: #ffffff;">
  <section class="wrapper">
    ...
    <div class="row">
        <div class="col-sm-10"><h1>Add funds</h1></div>
          ...
          <?php
            ...
            if (isset($_POST['addfunds'])) {
              ...
              if (empty($_POST['addamount'])) {
                  $addFundsMSG = '<p class="alert alert-danger">Amount Can not be empty.</p>';
                  $error = "1";
              }else{
                $addAmount = $_POST['addamount'];
              }
              if ($error=="1") {
                  $addFundsMSG = '<p class="alert alert-danger">Can not add money!.</p>';
              }else{
                $addFundQuery = mysqli_query($con,"INSERT INTO mlmmemberledger(userid, transdate,creditamount,debitamount,type,status) VALUES('$addusertoID','$addTransDate','$addAmount','0','$text_Received','$text_Available')");
                if ($addFundQuery) {
                  # code...
                  $addFundsMSG = '<p class="alert alert-success">Done! funds added successfully.</p>';
                  ...
                  <form class="form" action="" method="post" id="registrationForm">
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-xs-6">
                              ...
                              <input type="number" class="form-control" name="addamount">
                          </div>
                      </div>
                      <div class="form-group row">
                          <div class="col-xs-6">
                      ...
                      <div class="form-group">
                           <div class="col-xs-12">
                                <br>
                                <button class="btn btn-lg btn-success" name="addfunds" type="submit">Add Funds</button>
