...
<!DOCTYPE html>
<head>
<title>Change Lives Network : Genealogy</title>
...
<section id="main-content" style="background: #ffffff;">
    <section class="wrapper">
        <div class="container bootstrap snippet">
            <div class="row">
                <div class="col-sm-10"><h1>Genealogy</h1></div>
          ...
          <!-- <ul style="font-size: 14px;">
            <?php
              $sql="SELECT * FROM mlmmembers WHERE parentid='914'";
    ...
    <div class="genealogy-tree">
        <ul>
            <li>
                ...
                <ul class="active">
                    <?php
                      $geneasql="SELECT * FROM mlmmembers WHERE parentid='914' order by userid ASC";
