...
<section id="main-content" style="background: #ffffff;">
  <section class="wrapper">
    <?php if($deleteErrMSG){ echo $deleteErrMSG;} ?>
    <div class="card mb-4">
        <div class="card-header">
            <h2 class="alert alert-warning"><b><?php echo $annTitle;?></b></h2>
        </div>
        <div class="card-body">
          <h2 class="alert alert-warning">
            <?php echo $annMessage;?>
            <br><br>
            Published on: <?=$annPubDate;?>
            <br> <br>
            <form action="" method="POST">
              <input type="hidden" name="upid" value="<?=$upid;?>">
              <button name="deleteannouncement" class="btn btn-danger"><i class="fa fa-times"></i> Delete</button>
            </form>
          </h2>
        </div>
      </div>
