...
<!DOCTYPE html>
<head>
<title>Change Lives Network : New Announcement</title>
...
<section id="main-content" style="background: #ffffff;">
    ...
    <div class="row">
        <div class="col-sm-9">
            <?php if($announcememntErrMSG){ echo $announcememntErrMSG;}?>
                  ...
                  <form class="form" action="" method="post">
                      <div class="form-group row">
                          ...
                          <div class="col-xs-10">
                              ...
                              <input type="text" class="form-control" name="title" placeholder="Enter Title" title="Enter  Title" >
                          </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group">
                           <div class="col-xs-12">
                                <br>
                                <button class="btn btn-lg btn-success" name="publish" type="submit">Publish</button>
